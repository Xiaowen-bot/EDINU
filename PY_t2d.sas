...
cutoff:
NHS1 June of 2018.6 1422
HPFS January 2018.1 1417
...
%include '/udd/n2xwa/urate/cohort/nhscohort_t2d.sas';
%include '/udd/n2xwa/urate/cohort/hpfscohort_t2d.sas';
...
%pre_pm(data=nhs1,out=TWO,case=db2case,timevar=interval,irt=irt84 irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16,cutoff=1422,
dtdx=dtdxdb2, dtdth=dtdth,var=agegp FIq); 
%pm(data=TWO, case=db2case, exposure=FIq, strata=agegp);
%casepy(cohort=nhs1,exp=FIq, case=db2case);
...
%pre_pm(data=hpfs,out=TWO,timevar=interval,irt=rtmnyr86 rtmnyr88 rtmnyr90 rtmnyr92 rtmnyr94 rtmnyr96 rtmnyr98 rtmnyr00 rtmnyr02 rtmnyr04 rtmnyr06 rtmnyr08 rtmnyr10 rtmnyr12 rtmnyr14 rtmnyr16 ,cutoff=1417,dtdx=dtdxdb2, dtdth=dtdth,
case=db2case, var=agegp FIq); 
%pm(data=TWO, case=db2case, exposure=FIq, strata=agegp);
%casepy(cohort=hpfs,exp=FIq, case=db2case);
...
ODS RTF FILE='/udd/n2xwa/urate/cohort/casePY_pool_T2D.rtf' startpage=no; 
proc print data=casepy_db2case;
run;
ODS RTF CLOSE;
