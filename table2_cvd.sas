...
set hpfs nhs1 ;
 ...
 keep 
    ...
    /**Outcome******/
    dtdxcvdcabg CVDcaseca tcvdca
    dtdxchd CHDcase tchd
    dtdxchdcabg CHDCA tchdca 
    dtdxstr STRcase  tstr 
...
proc freq data=pool;tables CVDcaseca;run;
...
%let cov = hbpbase cholbase  pmh_ever oc_ever mvit aspirin mifh  &race_  &actc_   &smkc_  &qtei_  &bmib_;
...
%model_phreg1(dsn=pool,event=CVDcaseca, time=tcvdca, exp=&FIq_,  cov1=,     label=age,food=total,cat=);
%model_phreg1(dsn=pool,event=CVDcaseca, time=tcvdca, exp=&FIq_,  cov1=&cov, label=mvt,food=total,cat=);

%model_phreg1(dsn=pool,event=CVDcaseca, time=tcvdca, exp=FI_SD,  cov1=,     label=age,food=total,cat=sd);
%model_phreg1(dsn=pool,event=CVDcaseca, time=tcvdca, exp=FI_SD,  cov1=&cov, label=mvt,food=total,cat=sd);

%model_phreg1(dsn=pool,event=CHDCA, time=tchdca, exp=&FIq_,  cov1=,     label=age,food=total,cat=);
%model_phreg1(dsn=pool,event=CHDCA, time=tchdca, exp=&FIq_,  cov1=&cov, label=mvt,food=total,cat=);

%model_phreg1(dsn=pool,event=CHDCA, time=tchdca, exp=FI_SD,  cov1=,     label=age,food=total,cat=sd);
%model_phreg1(dsn=pool,event=CHDCA, time=tchdca, exp=FI_SD,  cov1=&cov, label=mvt,food=total,cat=sd);

%model_phreg1(dsn=pool,event=CHDCA, time=tchdca, exp=&FIqr_,  cov1=,     label=age,food=rank,cat=);
%model_phreg1(dsn=pool,event=CHDCA, time=tchdca, exp=&FIqr_,  cov1=&cov, label=mvt,food=rank,cat=);


%model_phreg1(dsn=pool,event=STRcase, time=tstr, exp=&FIq_,  cov1=,     label=age,food=total,cat=);
%model_phreg1(dsn=pool,event=STRcase, time=tstr, exp=&FIq_,  cov1=&cov, label=mvt,food=total,cat=);

%model_phreg1(dsn=pool,event=STRcase, time=tstr, exp=FI_SD,  cov1=,     label=age,food=total,cat=sd);
%model_phreg1(dsn=pool,event=STRcase, time=tstr, exp=FI_SD,  cov1=&cov, label=mvt,food=total,cat=sd);

%model_phreg1(dsn=pool,event=STRcase, time=tstr, exp=&FIqr_,  cov1=,     label=age,food=rank,cat=);
%model_phreg1(dsn=pool,event=STRcase, time=tstr, exp=&FIqr_,  cov1=&cov, label=mvt,food=rank,cat=);
...
set 
pool_CVDcaseca_age_total_       pool_CVDcaseca_mvt_total_
pool_CVDcaseca_age_total_sd     pool_CVDcaseca_mvt_total_sd 
pool_CHDCA_age_total_           pool_CHDCA_mvt_total_
pool_CHDCA_age_total_sd         pool_CHDCA_mvt_total_sd 
pool_CHDCA_age_rank_            pool_CHDCA_mvt_rank_
pool_STRcase_age_total_         pool_STRcase_mvt_total_
pool_STRcase_age_total_sd       pool_STRcase_mvt_total_sd 
pool_STRcase_age_rank_          pool_STRcase_mvt_rank_
;
...
ODS RTF FILE='./output/table2_pool_cvd.rtf' startpage=no; 
title '/*********************************Main**************************************/';
