...
Program Name:       /udd/n2xwa/urate_Wang/cohort/nhscohort_cvd.sas
...
proc sort data=GOUTPRS; by id; run;
    ...
    data xwang;
    merge diabetes disease_1 dead ahei2010_8420 familyhis GOUTPRS
...
/*For subgroup analysis*/
   ...
   %exclude(0 lt dtdxcvdcabg le irt{i}); 
...
/* EXCLUSIONS DURING FOLLOW-UP */
         if i>1 then do;
            %exclude(irt{i-1} lt dtdxcvdcabg le irt{i});          *CASES:CVD as outcome;
...
keep id agemo  agecon agegp &agegp_ interval agesub 
   ...
   dtdth alldead dead_can dead_cvd talld  dbfh  mifh  strfh prs_urate
   FIq FIqr
   &FIq_  &FIqr_
   FIcon FIconr
