...
Program Name:       /udd/n2xwa/urate_Wang/cohort/nhscohort_gout.sas
Last updated:       01/2025
Study design:

Prospective cohort study 
NHS: 1984-2010.6: (confirmed gout cases, we did not include self-reported only)
...
%serv94 (keep = id 
                ...
                muff_s94 pcake_s94 pasta_s94 tort_s94
                rwine_s94  wwine_s94)
...
/* Refined grain products */ rgrain10    = sum(whbr_s10, wrice_s10, engl_s10,   muff_s10, pcake_s10, pasta_s10, pretz_s10, crackot_s10, tort_s10);
...
/***PPP, use the standard read macro instead:
%ahei2010_8420
*/
...
%include '/udd/n2xwa/gout/nhs.dash.8410.sas';
...
proc sort data=GOUTPRS; by id; run;
    ...
    data xwang;
    merge gout dead ahei2010_8420 nhs_dash GOUTPRS 
...
array   dash    {8} dashq84 dashq86 dashq90 dashq94 dashq98 dashq02 dashq06 dashq10;
...
if dash{i}=. or cancee{i}=1 or hrtt{i}=1 or diabb{i}=1 or strokk{i}=1  then dash{i}=dash{i-1};
...
data xwang;
set xwang;
%cumavg(cycle=8, cyclevar=4,
  varin= 
          calor84n  alco84n ahei2010_84 dashq84
          calor86n  alco86n ahei2010_86 dashq86
          calor90n  alco90n ahei2010_90 dashq90
          calor94n  alco94n ahei2010_94 dashq94
          calor98n  alco98n ahei2010_98 dashq98
          calor02n  alco02n ahei2010_02 dashq02
          calor06n  alco06n ahei2010_06 dashq06
          calor10n  alco10n ahei2010_10 dashq10,
        
  varout=
          calor84nv alco84v ahei84_av dashq84v
          calor86nv alco86v ahei86_av dashq86v
          calor90nv alco90v ahei90_av dashq90v
          calor94nv alco94v ahei94_av dashq94v
          calor98nv alco98v ahei98_av dashq98v
          calor02nv alco02v ahei02_av dashq02v
          calor06nv alco06v ahei06_av dashq06v
          calor10nv alco10v ahei10_av dashq10v);
...
run;
  ...
  proc rank data=xwang out=quintile group=5;
            var  calor84nv  calor86nv   calor90nv   calor94nv   calor98nv   calor02nv   calor06nv   calor10nv
                 ...
                 dashq84v  dashq86v  dashq90v  dashq94v  dashq98v  dashq02v  dashq06v  dashq10v;
            ranks calor84q calor86q  calor90q   calor94q   calor98q   calor02q   calor06q   calor10q
              ...
              dashq84q  dashq86q  dashq90q  dashq94q  dashq98q  dashq02q  dashq06q  dashq10q;
...
PROC DATASETS;
delete    gout dead ahei2010_8420 nhs_dash serv84_cat serv86_cat serv90_cat serv94_cat serv98_cat serv02_cat serv06_cat serv10_cat
...
array   dashnv {13}      dashq84v  dashq86v  dashq86v  dashq90v  dashq90v  dashq94v  dashq94v  dashq98v  dashq98v  dashq02v  dashq02v  dashq06v  dashq06v;
array   qdash  {13}      dashq84q  dashq86q  dashq86q  dashq90q  dashq90q  dashq94q  dashq94q  dashq98q  dashq98q  dashq02q  dashq02q  dashq06q  dashq06q ;
...
**************************************************************************;
    ...
    cutoff=1326; /* nmw - cutoff 2010.6: (confirmed gout cases, we did not include self-reported only) */
...
smknever  prepau active bmicon oc_ever  aheiq &qahei_ aheim  dashqq &qdash_ dashm
