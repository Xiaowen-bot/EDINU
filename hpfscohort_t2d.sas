...
Program Name:       /udd/n2xwa/urate_Wang/cohort/hpfscohort_t2d.sas
...
famaily history of diabetes: dbfh
...
- exclude if history/baseline of CVD, diabetes, cancers
...
- missing T2D dx date and gestional db and T1D Difinite cases of type2 diabetes; 
- Suspected cases of type2 diabetes or cases of type1 diabetes and gestational diabetes;
- censor incident T2D, death
- censor Loss to follow-up


**************************************************
* HPFS cohort data (T2D)                *
**************************************************;
/******* General options *************************************/
...
/*Family history of DB*/
  ...
  %hp_der_2 (keep= smoke08  smoke10 smoke12 smoke14 smoke16 smoke18 
   ...
   %hp18(keep= hbp18 chol18 db18 mi18 cabg18 ang18 strk18 /* different from stk18*/
    ...
    data base0;
    merge diabetes hp_der(in=mst) hp_der_2 h86_cat h90_cat h94_cat h98_cat h02_cat h06_cat h10_cat h14_cat
...
array irt     {17} rtmnyr86 rtmnyr88 rtmnyr90 rtmnyr92 rtmnyr94 rtmnyr96 rtmnyr98 rtmnyr00 rtmnyr02 rtmnyr04 rtmnyr06 rtmnyr08 rtmnyr10 rtmnyr12 rtmnyr14 rtmnyr16  cutoff ;
...
array aspi   {16} asp86 asp88 asp90 asp92 asp94 asp96 asp00 asp02 asp04 asp06 asp08 asp10 asp10 asp12 asp12 asp12   ;


array calornv {16} calor86nv calor86nv calor90nv calor90nv calor94nv calor94nv calor98nv calor98nv calor02nv calor02nv calor06nv calor06nv calor10nv calor10nv calor14nv  calor14nv ;
...
array calorq {16} calor86q calor86q calor90q calor90q calor94q calor94q calor98q calor98q calor02q calor02q calor06q calor06q calor10q  calor10q calor14q calor14q ;
...
array cignm{16} cgnm86 cgnm88 cgnm90 cgnm92 cgnm94 cgnm96 cgnm98 cgnm00 cgnm02 cgnm04 cgnm06 cgnm08 cgnm10 cgnm12 cgnm14  cgnm16  ;
array smkm {16} smkm86 smkm88 smkm90 smkm92 smkm94 smkm96 smkm98 smkm00 smkm02 smkm04 smkm06 smkm08 smkm10 smkm12 smkm14 smkm16  ;
array smm  {16} smm86   smm88   smm90   smm92   smm94   smm96   smm98   smm00    smm02    smm04    smm06  smm08 smm10  smm12 smm14  smm16  ;


array weight  {16} wt86    wt88    wt90    wt92    wt94    wt96    wt98    wt00    wt02    wt04    wt06    wt08    wt10    wt12     wt14   wt16  ;
...
array alcocum {16} alco86v alco86v alco90v alco90v alco94v alco94v alco98v alco98v alco02v alco02v alco06v alco06v alco10v alco10v  alco14v  alco14v ;

array alcq    {16} alc86   alc86   alc90   alc90   alc94   alc94   alc98   alc98   alc02   alc02   alc06   alc06   alc10   alc10    alc14   alc14  ;

array actm    {16} act86   act88   act90   act92   act94   act96   act98   act00   act02   act04   act06   act08   act10   act12    act14 act14   ;
 
array FIm     {16}  FI86v   FI86v   FI90v   FI90v   FI94v   FI94v   FI98v   FI98v   FI02v   FI02v   FI06v   FI06v   FI10v FI10v FI14v FI14v ;

array FIs     {16}  FI86q FI86q FI90q FI90q FI94q FI94q FI98q FI98q FI02q FI02q FI06q FI06q FI10q FI10q FI14q FI14q ;

array FImr    {16} FI86vr FI86vr FI90vr FI90vr FI94vr FI94vr FI98vr FI98vr FI02vr FI02vr FI06vr FI06vr FI10vr FI10vr FI14vr FI14vr;
array FIsr    {16} FI86qr FI86qr FI90qr FI90qr FI94qr FI94qr FI98qr FI98qr FI02qr FI02qr FI06qr FI06qr FI10qr FI10qr FI14qr FI14qr;
...
if actcon>7.5 then active=1; else active=0;
   ...
   %exclude(0 lt dtdth le irt{i});              *Death before 1986;   
        ...
        %exclude(0 lt dtdxdb le irt{i});            *baseline bd;   
   ...
   %exclude(calor86n eq .);
   %exclude(dtdxdb2 eq 9999);                        *missing T2D dx date and gestional db and T1D;
   %output();
  end;

  else if i> 1 then do;
    %exclude(irt{i-1} lt dtdxdb2 le irt{i});           *Difinite cases of type2 diabetes, here db or type2db;
            %exclude(irt{i-1} lt dtdxdb le irt{i});            *Suspected cases of type2 diabetes or cases of type1 diabetes and gestational diabetes;
            %exclude(irt{i-1} le dtdth lt irt{i});            /* DEATHS */ 
            %exclude(irt{i-1} lt ltf le irt{i});               *lost to follow-up;
...
data hpfs;
  ...
  rtmnyr86 rtmnyr88  rtmnyr90 rtmnyr92 rtmnyr94 rtmnyr96 rtmnyr98 rtmnyr00 rtmnyr02 rtmnyr04 rtmnyr06 rtmnyr08 rtmnyr10 rtmnyr12 rtmnyr14   rtmnyr16
